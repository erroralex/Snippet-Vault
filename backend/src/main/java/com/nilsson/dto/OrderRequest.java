 ...
 * updating the sort order of an entity.
 * </p>
 * <p>
 ...
 * </ul>
 * <p>
 * <strong>Technical Role:</strong> A Java record used in API requests to
 * specify the new ordering for items, typically in a list or hierarchical
 * structure. Records provide a concise syntax for immutable data carriers.
 * </p>
 * ──────────────────────────────────────────────
 */
