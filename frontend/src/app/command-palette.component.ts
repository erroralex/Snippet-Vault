...
/**
 * A fast, keyboard-driven interface for navigating snippets and executing application commands.
 *
 * The Command Palette provides an overlay that allows users to quickly search through
 * their snippets, access recent ones, or trigger predefined actions (commands) without
 * taking their hands off the keyboard. It acts as a unified search and control center,
 * typically summoned via a global shortcut (e.g., Ctrl+P or Cmd+P). The component
 * dynamically filters results based on user input, matching against snippet titles,
 * languages, tags, descriptions, and command keywords. It supports keyboard navigation
 * (up/down arrows) and selection (enter) for rapid interaction.
 */
@Component({
  ...
  styles: [`
    ...
    .palette-panel {
      ...
      border: 1px solid rgba(102,252,241,0.2); border-radius: 12px;
      overflow: hidden;
    ...
    .palette-search-row {
      ...
      background: linear-gradient(135deg, rgba(102,252,241,0.03), rgba(216,112,255,0.03));
    }
