...
/**
 * ──────────────────────────────────────────────
 * <h2>BulkActionBarComponent</h2>
 * ──────────────────────────────────────────────
 * <p><strong>Responsibility:</strong> Provides a contextual action bar for executing operations on multiple selected snippets simultaneously.</p>
 * <p><strong>Functions:</strong></p>
 * <ul>
 * <li>Dynamically appears at the bottom of the screen when one or more snippets are selected.</li>
 * <li>Displays the current count of selected snippets.</li>
 * <li>Allows users to move all selected snippets to a specific folder or to the root inbox.</li>
 * <li>Provides a bulk deletion function with a confirmation prompt.</li>
 * <li>Includes an action to clear the current selection.</li>
 * </ul>
 * <p><strong>Technical Role:</strong> An Angular {@code @Component} that monitors the selection state in the {@code SnippetService} and triggers bulk update or delete operations based on user interaction.</p>
 * ──────────────────────────────────────────────
 */
@Component({
